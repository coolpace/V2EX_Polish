...
`;$.fn.extend({insertAtCaret:function(t){return this.each(()=>{if(this.selectionStart||this.selectionStart=="0"){let e=this.selectionStart,o=this.selectionEnd,n=this.scrollTop;this.value=this.value.substring(0,e)+t+this.value.substring(o,this.value.length),this.focus(),this.selectionStart=e+t.length,this.selectionEnd=e+t.length,this.scrollTop=n}else this.value+=t,this.focus()}),this}});function me(){let t=V.filter(({likes:e})=>e>0).sort((e,o)=>o.likes-e.likes);if(t.length>4||t.length>0&&t.every(({likes:e})=>e>=4)){let e=$('<div class="v2p-cm-mask">'),o=$(`
